...
process.source = cms.Source("HGCalTBTextSource",
                            ...
                            fileNames=cms.untracked.vstring("file:./rearranged_output/HGC_Output_42.txt"), ### here a vector is provided, but in the .cc only the first one is used TO BE FIXED
